...
do
    ...
    --n_rollout_threads 129 --n_eval_rollout_threads 63 --episode_length 25 \
    --num_env_steps 200000000 --ppo_epoch 10 --use_ReLU --gamma 0.99 0.99 \
    --wandb_name "cwz19" --user_name "cwz19" --eval_interval 15 \
    --use_eval --max_z 3 --div_thresh 1.25 --discri_lr 1e-4 --rex_thresh -80
done